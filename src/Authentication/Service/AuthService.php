...
class AuthService
{
    ...
    {
        unset(
            $_SESSION[self::ATTR_ISADMIN],
            $_SESSION[self::ATTR_ISLOGGEDIN],
            $_SESSION[self::ATTR_USERID],
            $_SESSION[self::ATTR_USERNAME]
        );
    ...
    public function forbidden()
    {
        ...
        $contents = file_get_contents(
            $viewSettings['template_path'] . '/../templates/common/403.php',
            true
        );
